    ...
    fr: {
        ...
        employees: {
            ...
            importModal: {
                ...
                linesDetectedSingular: "ligne détectée.",
                newEmployees: "Nouveaux employés",
                newEmployeesSingular: "Nouvel employé",
                readyImport: "Prêts à importer",
                readyImportSingular: "Prêt à importer",
                duplicates: "Doublons détectés",
                willIgnore: "Seront ignorés",
                hasPin: "ont déjà un code PIN.",
                hasPinSingular: "a déjà un code PIN.",
                autoPin: "recevront un code auto.",
                autoPinSingular: "recevra un code auto.",
                importBtn: "Importer {count} employés",
                importBtnSingular: "Importer {count} employé",
    ...
    en: {
        ...
        employees: {
            ...
            importModal: {
                ...
                linesDetectedSingular: "line detected.",
                newEmployees: "New employees",
                newEmployeesSingular: "New employee",
                readyImport: "Ready to import",
                readyImportSingular: "Ready to import",
                duplicates: "Duplicates detected",
                willIgnore: "Will be ignored",
                hasPin: "already have a PIN code.",
                hasPinSingular: "already has a PIN code.",
                autoPin: "will receive an automatic code.",
                autoPinSingular: "will receive an automatic code.",
                importBtn: "Import {count} employees",
                importBtnSingular: "Import {count} employee",
